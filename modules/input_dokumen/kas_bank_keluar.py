...
def render_kas_bank_keluar():
  ...
  st.markdown("<p style='font-size:12px; color:#64748B;'>Gunakan tombol tambah (+) di bawah tabel untuk menambah baris. Untuk menghapus baris, centang kotak di sisi kiri baris lalu tekan tombol Delete pada keyboard.</p>", unsafe_allow_html=True)
  ...
  edited_df = st.data_editor(
      ...
      column_config={
          ...
          "Qty": st.column_config.NumberColumn(
              "Qty", width="small", min_value=0.0, step=1.0
          ),
  ...
  with col_b1:
    ...
    if st.button(label_tombol_simpan, use_container_width=True, key=f"btn_save_kbk_{idx}"):
      ...
      if valid_kondisi:
        ...
        # Simpan struktur multi-item lengkap ke format JSON
        ...
        # Simpan secara permanen ke file Excel
